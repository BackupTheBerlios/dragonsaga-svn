    ...
    while (list($key,$val)=each($order))
    {
        switch($val)
        {
	        ...
	        // NOTICE
                ...
                output("`n`nThe majority of the game code came from Legend of the Green Dragon, another similar project, that is now developed 
                        under the <a href=\"http://creativecommons.org/licenses/by-nc-sa/2.0/\">Creative Commons License.</a>",true);
